 ...
 * @Last Modified time: 2019-02-14 09:43:41
 */
var v = _config.VERSION || '';
var output = _config.PROD_OUTPUT || 'dist';

if (process.env.RUN_TEST) {
  v = _config.VERSION + '.release';
  output = _config.RELEASE_OUTPUT;
}

if (process.env.RUN_DEV) {
  v = _config.VERSION + '.dev';
  output = _config.DEV_OUTPUT;
}
...
_webpack5.default.output = {
  ...
  path: _path2.default.resolve(_config.DEFAULT_PATH, output),
  publicPath: '/'
};
