...
if ((0, _fs.existsSync)(process.cwd() + '/webpackrc.js')) {
  var _webpack = require(process.cwd() + '/webpackrc.js');
  ...
  if (rules && rules.length) {
    rules.map(function (item) {
      _webpack5.default.module.rules.push({
        ...
        use: extractApp.extract([].concat((0, _toConsumableArray3.default)(item.use)))
      });
    });
  }
}
