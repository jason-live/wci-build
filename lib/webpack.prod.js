...
_webpack4.default.devtool = 'cheap-module-source-map';

/**
 * [entry description]
 * @type {Object}
 */
_webpack4.default.entry = {
...
_webpack4.default.plugins.push(extractAntd);
_webpack4.default.plugins.push(extractApp);
_webpack4.default.plugins.push(new _webpack2.default.optimize.CommonsChunkPlugin({
