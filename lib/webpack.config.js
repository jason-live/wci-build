...
var mfsAntd = _lodash["default"].map(_lodash["default"].filter(dll.manifest, {
  type: 'json',
  name: dllType
}), 'filename');

var mfsCommon = _lodash["default"].map(_lodash["default"].filter(dll.manifest, {
  type: 'json',
  name: 'common'
}), 'filename');

var urls = _lodash["default"].concat(urlsAntd, urlsCommon);

var mfs = _lodash["default"].concat(mfsAntd, mfsCommon);
