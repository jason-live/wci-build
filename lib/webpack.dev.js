...
* @type {String}
*/
_webpack5.default.mode = 'development';
 ...
 * @Last Modified time: 2019-04-18 11:04:14
...
* @type {Array}
*/
_webpack5.default.entry = ['webpack/hot/dev-server', 'webpack-dev-server/client?http://' + _config.DEFAULT_HOSTNAME + ':' + _config.DEFAULT_PORT, _path2.default.resolve(_config.DEFAULT_PATH, _config.DEFAULT_INDEX + '/')];
...
_webpack5.default.output = {
  ...
  path: _path2.default.resolve(_config.DEFAULT_PATH, _config.DEFAULT_SRC),
  publicPath: 'http://' + _config.DEFAULT_HOSTNAME + ':' + _config.DEFAULT_PORT + '/'
};
  ...
  if (rules && rules.length) {
    rules.map(function (item) {
      _webpack5.default.module.rules.push({
        ...
        use: [].concat((0, _toConsumableArray3.default)(item.useDev))
      });
    });
  }
}
...
_webpack5.default.plugins.push(new _openBrowserWebpackPlugin2.default({
  url: 'http://' + _config.DEFAULT_HOSTNAME + ':' + _config.DEFAULT_PORT
}));
