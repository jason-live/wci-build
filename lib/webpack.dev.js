...
_webpack5.default.module.rules.push({
  ...
  use: [getStyleLoader(), getCssLoader('antd'), getLessLoader('antd', require(process.cwd() + '/app/scripts/util/theme'))]
});
...
if (require(process.cwd() + '/.webpackrc')) {
  var _webpack = require(process.cwd() + '/.webpackrc');
